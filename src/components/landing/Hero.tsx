    ...
    <section className="relative pt-32 pb-16 lg:pt-40 lg:pb-10 overflow-hidden bg-white">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <a target="_blank" href="https://github.com/ankit078588" className="w-full sm:w-auto px-10 py-4 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-full font-bold text-lg transition-all flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-slate-200/50">
